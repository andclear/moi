...
const QUESTIONNAIRE_LOADING_REVEAL_MS = 650;
...
export function StepQuestionnaireLoading() {
  ...
  useEffect(() => {
    ...
    }, QUESTIONNAIRE_LOADING_DURATION_MS + QUESTIONNAIRE_LOADING_REVEAL_MS);
  ...
  return (
    <main className="overflow-hidden bg-[var(--animal-bg)]" style={{ position: "relative", height: "100vh" }}>
