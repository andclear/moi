  ...
  return [
    {
      ...
      content: [
        ...
        "",
        "## 动态维度框架",
        "根据请求类型，选择合适的维度组合，content 必须包含维度标题：",
        "",
        "* [宏观概念]（国家/派系/种族）",
        ...
        "2. 严格结构：在 content 字段内部，使用 `【维度名称】：` 引领。",
        "3. 信息密度：以老练观察者的笔触书写。每个句子都必须提供新的信息。",
        "4. 视觉分隔：在 content 字段内使用 `\\n\\n`（双换行）分隔逻辑段落。",
        "5. 字段要求：每个条目必须包含 comment、content、constant、keys、position、depth、insertion_order。",
        "6. constant 是布尔值；keys 是 string[]；position 是 0-4 的数字；depth 在 position 为 4 时必须为数字，其他情况可为空字符串；insertion_order 是数字，建议从 100 开始。",
        "",
        "## 输出结构示例",
        '[{"comment":"<条目名称1>","content":"【维度1】：具体描述……\\n\\n【维度2】：具体描述……","constant":true,"keys":[],"position":4,"depth":4,"insertion_order":102},{"comment":"<条目名称2>","content":"……","constant":false,"keys":["关键词1","关键词2"],"position":2,"depth":"","insertion_order":101}]',
        "",
        "## 执行",
