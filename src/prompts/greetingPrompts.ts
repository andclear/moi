  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        "",
        "## 关键约束与质量标准",
        "1. 变量协议：最终输出中必须使用确切字符串 {{char}} 和 {{user}}。禁止用真实姓名替换。",
        "2. 第一人称：必须使用“我”指代 {{char}}，聚焦 {{char}} 的主观视角与内心反应。",
        "3. 第二人称：必须聚焦 {{user}} 的所见、所闻、所感，{{char}} 从外部视角出现。",
        "4. 第三人称：必须使用 {{char}} 或他/她指代角色，采用电影化客观镜头。",
        "5. 篇幅必须接近目标字数，不要明显过短。",
