  ...
  return [
    {
      ...
      content: [
        ...
        "严格使用简体中文。最终开场白必须保留字面占位符 {{user}} 代表用户，角色必须使用角色信息 YAML 中的真实姓名。",
        "严格代称规则：凡是涉及用户的主语、宾语、称呼、动作承受者或身体部位所属者，都必须直接写 {{user}}，不得写“你”“对方”“那个人”“客人”“玩家”等代称。",
        `严格代称规则：凡是涉及角色本身的主语、宾语、称呼、动作承受者或身体部位所属者，都必须直接写 ${characterName}，不得写“我”“他”“她”“TA”“少女”“男人”“女人”等代称。`,
    ...
    },
    {
      ...
      content: [
        ...
        "",
        "## 关键约束与质量标准",
        `1. 变量协议：最终输出中必须使用确切字符串 {{user}} 代表用户；所有角色位置必须写 ${characterName}。`,
